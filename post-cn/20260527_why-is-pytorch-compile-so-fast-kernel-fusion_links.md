...
为了简洁起见，接下来的内核我们只列出函数签名，因为它们几乎相同，完整源代码请参见我们的 Git 仓库。
...
**了解更多**：PyTorch 文档 pytorch.org/docs/stable/torch.compiler.html 提供了关于编译和优化策略的完整指南。完整源代码请参见我们的 Git 仓库。
...
- 完整源代码 Git 仓库: https://gist.github.com/morrison-turnansky/0cc51b498c674aa23d4718ae200e6209
- PyTorch 编译器文档: http://pytorch.org/docs/stable/torch.compiler.html
